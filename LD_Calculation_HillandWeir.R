...
ld <- read.table("SAP_mixed_LD_50_tassel_maf0.05.txt",stringsAsFactors = FALSE,header=TRUE)
...
#file <- file2[file2$rsq > 0.01,]
#rsq0.5dist10kb <- file[file$dist < 19213 & file$rsq >0.23,]

#test if there are any NAs or NaN
#isTRUE(file$rsq=="NA")
#isTRUE(file$rsq=="NaN") 

# this data was obtained from genotyping of 250 individuals, so n = no. of gametes = no. of sampled chromosomes = 2 x 389
#n = 2*82
